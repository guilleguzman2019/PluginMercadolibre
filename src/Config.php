...
class Config
{
    ...
    * @example ['post_data'=>'INJQEW::function']
    */
    public $post=[];
    /**
    * GET data process
    * get the get data and execute the function
    * @example ['get_data'=>'INJQEW::function']
    */
    public $get=[];
    /**
    * add_filter data functions
    * @input array
    * @example ['body_class','INJQEW::function',10,2]
    * @example ['body_class',['INJQEW','function'],10,2]
    */
    public $add_filter=[];
    /**
    ...
    * @input array
    * @example [['example','INJQEW\ExampleController::example_shortcode']]
    */
    public $shortcodes=[
        ['example','INJQEW\ExampleController::example_shortcode']
    ];
    /**
    * Dashboard
    ...
    */
    public $plugin_menu=[
        ...
        [
            "path"      => ["page"],
            "name"      => "Mercadolibre",
            "function"  => __NAMESPACE__."\ControllerMercadolibre::login",
